...
class DashBoardState {
  ...
  DashBoardState copyWith(
    ...
    return DashBoardState(
      ...
      organizationOverviewModel: organizationOverviewModel ?? OrganizationOverviewModel(),
...
class DashBoardProvider extends StateNotifier<DashBoardState> {
  ...
  Future<void> getCachedOrganizationOverview() async {
    try {
      ...
      if(res!=null){
        setOrganizationOverView = OrganizationOverviewModel.fromJson(jsonDecode(res));
      }
    } catch (e) {
      //tODO: Do something with caught error;
    } finally {
  ...
  Future<bool> saveSalesTrend(List<GetSalesTrend> value)async{
    try{
      _storageService.write("sales_trend", getSalesTrendListFromJsontoString(value));
