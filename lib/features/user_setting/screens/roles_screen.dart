          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Divider(),
                PermissionsListTile(isPermitted: true, permissionTitle: 'Can view transactions'),
                PermissionsListTile(isPermitted: true, permissionTitle: 'Can view refunds'),
                PermissionsListTile(isPermitted: true, permissionTitle: 'Can log refunds'),
                PermissionsListTile(isPermitted: false, permissionTitle: 'Can view users'),
                PermissionsListTile(isPermitted: true, permissionTitle: 'Can create users'),
                PermissionsListTile(isPermitted: true, permissionTitle: 'Can edit users'),
                PermissionsListTile(isPermitted: true, permissionTitle: 'Can blacklist/whitelist users'),
              ],
            ),
          ),
           SizedBox(
